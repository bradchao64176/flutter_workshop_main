...
class _KeysState extends State<Keys> {
  ...
  List<Todo> get _orderedTodos {
    final sortedTodos = List.of(
        _todos); // use the copy of List, it won't change original todos object
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                //TODO: 148. Replace as CheckableTodoItem
                CheckableTodoItem(
                  //TODO: 149. add ValueKey to identify the todo widget and its state
